...
add_fileset_file UART_Fast.v VERILOG PATH UART_Fast.v TOP_LEVEL_FILE
add_fileset_file UART_Fast_Connector.v VERILOG PATH UART_Fast_Connector.v
...
add_interface_port conduit_end uart_rx rx Input 1
add_interface_port conduit_end uart_tx tx Output 1
